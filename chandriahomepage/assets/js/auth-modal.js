...
class AuthModal {
    ...
    initializeEventListeners() {
        ...
        const signInFormElement = document.getElementById(
            "signin-form-element"
        );
        const signUpFormElement = document.getElementById(
            "signup-form-element"
        );
        const forgotFormElement = document.getElementById(
            "forgot-form-element"
        );
    ...
    openModal() {
        ...
        setTimeout(() => {
            const firstInput = this.getCurrentForm().querySelector(
    ...
    async handleSignIn(event) {
        ...
        try {
            ...
            if (isAdmin) {
                ...
                // SAVE TO LOCAL STORAGE IF ADMIN ACCOUNT LOGGED IN
                ...
                // SAVE TO LOCAL STORAGE IF USER ACCOUNT LOGGED IN
    ...
    async handleGoogleSignIn() {
        try {
            ...
            if (adminDocSnap.exists()) {
                ...
                this.notyf.success(
                    "Admin Google sign-in successful! Redirecting to admin panel..."
                );
    ...
    setupPasswordToggles() {
        ...
        const passwordFields = this.modal.querySelectorAll(
            'input[type="password"]'
        );
        ...
        passwordFields.forEach(field => {
            ...
            const toggleExists =
                field.parentNode.querySelector(".password-toggle");
            if (!toggleExists) {
    ...
    window.showAuthModal = () => {
        ...
        if (userEmail && currentUser && currentUser.emailVerified) {
            ...
            if (
                ...
                !currentPath.includes("chandriahomepage")
            ) {
