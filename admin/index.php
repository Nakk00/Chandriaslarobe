...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (pg_num_rows($check_result) > 0) {
        echo "<input type='hidden' id='registrationSuccess' value='0'>";
    } else {
        ...
        if ($result) {
            $registrationSuccess = 1; // Registration success
        } else {
            echo "<input type='hidden' id='registrationSuccess' value='0'>";
        }
    }
...
<html>
  ...
  <body>
    <!-- Hidden success flag -->
    <input type="hidden" id="registrationSuccess" value="<?php echo $registrationSuccess; ?>">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        // Check for registration success and show the success alert
        const successInput = document.getElementById("registrationSuccess");
