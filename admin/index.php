...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (pg_num_rows($check_result) > 0) {
        echo "<script>showErrorAlert('Username or email already exists.');</script>";
    } else {
        ...
        if ($result) {
            ...
            echo "<script>showErrorAlert('Error: Unable to register user.');</script>";
        }
    }
}
?>
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      // Show Error Alert for Registration
